...
import { citasGet, citasPost, citasPut, citaEstadoPut, citasDelete } from '../controllers/citaController.js';
...
router.put('/:id', [validarJWT, tieneRol('administrador', 'recepcionista')], citasPut);
